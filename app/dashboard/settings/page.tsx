      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="glass-card">
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <Link
                href="/user-profile"
                className="cta-button bg-white/10 text-white px-6 py-2 rounded-full border border-white/10 hover:bg-white/20 transition-all duration-300"
              >
                Edit Profile
              </Link>
            </div>
        ...
        <div className="space-y-8">
          ...
          <div className="glass-card border border-red-500/30">
            <div className="border-b border-white/10 pb-4 mb-6">
              <h3 className="text-xl font-semibold flex items-center gap-3 text-red-400">
            ...
            <div className="space-y-4">
              ...
              <Link
                href="/user-profile"
                className="cta-button bg-gradient-to-r from-neon-blue to-neon-purple text-white px-6 py-3 rounded-full font-semibold shadow-lg shadow-purple-500/40 hover:scale-105 transition-all duration-300 block text-center"
              >
                Manage Account
              </Link>
            </div>
